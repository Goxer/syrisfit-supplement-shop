...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center py-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6">
        ...
        <div className="order-2 lg:order-1">
          <div className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
            <div className="bg-black/5 inline-block px-4 py-2 rounded-full mb-4">
              <p className="text-black font-medium text-sm">Nuevo Producto Destacado</p>
            </div>
          </div>
          ...
          >
            ...
            <span className="text-black">100% Creatina</span>
          </h1>
          ...
          >
            <Button 
              size="lg" 
              className="bg-black hover:bg-black/90 text-white px-8 py-6 text-lg transition-all w-full sm:w-auto"
            >
            ...
            <Link to="/product/1">
              <Button 
                variant="outline" 
                size="lg" 
                className="border-black text-black hover:bg-black/5 px-8 py-6 text-lg w-full sm:w-auto"
              >
                Ver Detalles
        ...
        <div className="order-1 lg:order-2 flex justify-center items-center">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-gray-200/40 to-gray-200/40 rounded-full blur-3xl"></div>
            <img 
